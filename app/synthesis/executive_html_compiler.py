...
class ExecutiveHtmlCompiler:
    ...
    def compile_executive_report(
        ...
        lines.append(f"    <title>⚠️ PROTOTYPE DEMO REPORT — PPAC Monthly Ready Reckoner {period_id}</title>")
        lines.append("    <style>")
        lines.append("        :root {")
        ...
        lines.append("    </style>")
        lines.append("    <script>")
        lines.append(f"        const STORAGE_KEY = 'ppac_report_{period_id}_v3_edits';")
        ...
        lines.append('            <span class="chromebook-bar-title">📄 ⚠️ PROTOTYPE DEMO REPORT · PPAC Sovereign Hydrocarbon Report · Live Interactive Editor</span>')
        ...
        lines.append('            <div class="draft-header-tag">⚠️ PROTOTYPE DEMO REPORT</div>')

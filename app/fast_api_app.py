...
app.title = "PPAC Autonomous Reporting & Econometric Forecasting Agent"
app.description = "API for interacting with the PPAC Sovereign Reporting Agent in Gemini Enterprise"

...
root_agent = Agent(
    ...
    instruction=(
        ...
        "- compile_statutory_report: Compiles and signs off on the official 15-page HTML and executive Word DOCX in the sovereign lake. In your prose reply, ALWAYS provide the direct interactive, live-editable HTML link (https://storage.cloud.google.com/og-sovereign-ppac-data/3_artifacts/2026-08/approved/PPAC_Executive_Report_2026-08_Approved.html) and summarize key highlights. Do NOT provide Google Docs links as the sovereign HTML edition is the official interactive publication.\n\n"
        "SURFACES & DISPLAY:\n"

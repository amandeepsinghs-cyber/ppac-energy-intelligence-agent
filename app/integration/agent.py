...
root_agent = Agent(
    ...
    instruction=(
        ...
        "- compile_statutory_report: Compiles and signs off on the official 15-page HTML and executive Word DOCX in the sovereign lake. Call this whenever the user asks to compile or publish the official August 2026 PPAC Monthly Ready Reckoner or Executive Report. In your prose reply, ALWAYS state prominently at the top that this is the '⚠️ PROTOTYPE DEMO REPORT', provide the interactive live-editable HTML links (both the local live preview and the cloud storage link), and summarize key highlights. Do NOT provide Google Docs links as the sovereign HTML edition is the official interactive publication.\n\n"
        "SURFACES & DISPLAY:\n"
